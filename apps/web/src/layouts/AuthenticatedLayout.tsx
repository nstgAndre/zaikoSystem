...
import { ResponsiveNavButton, ResponsiveNavLink } from '../components/ResponsiveNavLink';
...
/**
 * Breeze の AuthenticatedLayout の忠実移植。
 * モバイルメニューの「Dashboard」リンクは現行の Breeze 残骸をそのまま再現している
 * (migration-spec.md §2.2 ⚠️D。リンク先ページは存在しない — 現行も同様)。
 */
          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              <div className="shrink-0 flex items-center">
                <Link to="/index">
                  <img
                    src="/images/在庫管理最新.png"
                    alt="在庫管理"
                    className="block h-40 w-[180px]"
                  />
                </Link>
              </div>
              ...
              <div className="ms-3 relative">
                <Dropdown>
                  ...
                  <Dropdown.Content>
                    ...
                    <Dropdown.Button onClick={signOut}>Log Out</Dropdown.Button>
                  </Dropdown.Content>
                </Dropdown>
              </div>
            </div>
        ...
        <div className={`${showingNavigationDropdown ? 'block' : 'hidden'} sm:hidden`}>
          ...
          <div className="pt-4 pb-1 border-t border-gray-200">
            ...
            <div className="mt-3 space-y-1">
              ...
              <ResponsiveNavButton onClick={signOut}>Log Out</ResponsiveNavButton>
            </div>
          </div>
        </div>
      </nav>
